...
func TestClient_HandleMessage_Subscribe(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_HandleMessage_Subscribe",
			category: "positive",
			run: func(t *testing.T) {
				client, mockManager, _ := setupClientTest()
...
func TestClient_HandleMessage_Unsubscribe(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_HandleMessage_Unsubscribe",
			category: "positive",
			run: func(t *testing.T) {
				client, mockManager, _ := setupClientTest()
				channelName := "test-channel"
...
func TestClient_HandleMessage_PresenceHeartbeat(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_HandleMessage_PresenceHeartbeat",
			category: "positive",
			run: func(t *testing.T) {
...
func TestClient_HandleMessage_Message(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_HandleMessage_Message",
			category: "positive",
			run: func(t *testing.T) {
				client, mockManager, _ := setupClientTest()
				msg := ClientMessage{
...
func TestClient_HandleMessage_UnknownType(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Negative_HandleMessage_UnknownType",
			category: "negative",
			run: func(t *testing.T) {
				client, mockManager, _ := setupClientTest()
...
func TestClient_HandleMessage_InvalidJSON(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Negative_HandleMessage_InvalidJSON",
			category: "negative",
			run: func(t *testing.T) {
				client, mockManager, _ := setupClientTest()
...
func TestClient_SendJSON_MarshalError(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Negative_SendJSON_MarshalError",
			category: "negative",
			run: func(t *testing.T) {
				client, _, _ := setupClientTest()
