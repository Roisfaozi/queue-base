...
func TestWebSocketManager_MultipleSubscriptions(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_MultipleSubscriptions",
			category: "positive",
			run: func(t *testing.T) {
...
func TestWebSocketManager_MultipleClientsIndependent(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_MultipleClientsIndependent",
			category: "positive",
			run: func(t *testing.T) {
				manager, server := setupTestServer()
				if server == nil {
...
func TestWebSocketManager_GetChannelClients(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_GetChannelClients",
			category: "positive",
			run: func(t *testing.T) {
				manager, server := setupTestServer()
				if server == nil {
...
func TestWebSocketManager_BroadcastToEmptyChannel(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Success_BroadcastToEmptyChannel",
			category: "positive",
			run: func(t *testing.T) {
				manager, server := setupTestServer()
				if server == nil {
...
func TestWebSocketManager_InvalidMessageType(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "Negative_InvalidMessageType",
			category: "negative",
			run: func(t *testing.T) {
				manager, server := setupTestServer()
				if server == nil {
