...
- `llm/test-playbooks/qms-load-resilience.md`: Phase 12 load/resilience playbook for concurrent numbering, rollback proof, scanner burst smoke, and operational triage.
