...
- verification:
  ...
  - result: passed
  - command: `PATH=/home/user/sdk/go/bin:$PATH GOCACHE=/tmp/gocache GOLANGCI_LINT_CACHE=/tmp/golangci-lint-cache go test ./tests/integration/modules -tags=integration -run TestIntegration_QMSJourneyLifecycle -count=1`
