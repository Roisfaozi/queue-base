...
func TestVulnerability_RegisterUser_XSS(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "TestVulnerability_RegisterUser_XSS",
			category: "negative",
			run: func(t *testing.T) {
...
func TestEdgeCase_RegisterUser_LongUsername(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "TestEdgeCase_RegisterUser_LongUsername",
			category: "positive",
			run: func(t *testing.T) {
...
func TestVulnerability_UpdateUser_XSS(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "TestVulnerability_UpdateUser_XSS",
			category: "negative",
			run: func(t *testing.T) {
