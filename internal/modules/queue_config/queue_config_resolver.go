...
import (
	...
	settingsModel "github.com/Roisfaozi/queue-base/internal/modules/queue_config/model"
...
type QueueConfigResolver struct {
	db *gorm.DB
}

func NewQueueConfigResolver(db *gorm.DB) *QueueConfigResolver {
	return &QueueConfigResolver{db: db}
}

func (r *QueueConfigResolver) Resolve(ctx context.Context, key string, branchID string, serviceID string, counterID string) (string, error) {
...
func (r *QueueConfigResolver) ResolveDetailed(ctx context.Context, key string, branchID string, serviceID string, counterID string) (*settingsModel.ResolvedQueueSetting, error) {
...
func (r *QueueConfigResolver) resolveTypedDetailed(ctx context.Context, key string, branchID, serviceID, counterID string) (*settingsModel.ResolvedQueueSetting, error) {
	if r.db == nil {
