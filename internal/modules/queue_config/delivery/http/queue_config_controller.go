...
func (h *QueueConfigController) EffectiveQueueConfig(c *gin.Context) {
...
func (h *QueueConfigController) ResetBranchQueueSetting(c *gin.Context) {
	h.resetQueueSetting(c, "branch_queue_settings", "branch_id", branchParam(c), c.Param("field"))
}

func (h *QueueConfigController) ResetBranchServiceQueueSetting(c *gin.Context) {
	h.resetQueueSetting(c, "branch_service_queue_settings", "branch_service_id", c.Param("branch_service_id"), c.Param("field"))
}

func (h *QueueConfigController) ResetCounterQueueSetting(c *gin.Context) {
	h.resetQueueSetting(c, "counter_queue_settings", "counter_id", c.Param("counter_id"), c.Param("field"))
}

func (h *QueueConfigController) resetQueueSetting(c *gin.Context, table, idColumn, id, field string) {
	if h.db == nil || id == "" {
...
func (h *QueueConfigController) EffectiveBranchConfig(c *gin.Context) {
	h.effectiveQueueConfigFor(c, model.EffectiveQueueConfigRequest{BranchID: branchParam(c)})
}

func (h *QueueConfigController) EffectiveBranchServiceConfig(c *gin.Context) {
	h.effectiveQueueConfigFor(c, model.EffectiveQueueConfigRequest{BranchID: branchParam(c), ServiceID: c.Param("service_id")})
}

func (h *QueueConfigController) EffectiveCounterConfig(c *gin.Context) {
...
func (h *QueueConfigController) effectiveQueueConfigFor(c *gin.Context, req model.EffectiveQueueConfigRequest) {
	tenantID := database.GetTenantID(c.Request.Context())
	if tenantID == "" {
		response.BadRequest(c, exception.ErrBadRequest, "missing tenant context")
		return
...
func (h *QueueConfigController) resolveEffectiveQueueConfig(ctx context.Context, tenantID string, req model.EffectiveQueueConfigRequest) (*model.EffectiveQueueConfigResponse, error) {
...
func (h *QueueConfigController) tryAudit(ctx context.Context, action, entityID string, values map[string]string) {
	if h.audit == nil {
		return
	}
...
func (h *QueueConfigController) resolveEffectiveLogoAssetID(ctx context.Context, tenantID, branchID string) string {
