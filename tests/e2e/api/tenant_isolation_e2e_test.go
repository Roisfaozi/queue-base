...
func TestCrossTenantIsolation_ProjectAccess(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "User A can read own project",
			category: "positive",
			run: func(t *testing.T) {
		...
		{
			name:     "User B cannot read Org A project",
			category: "negative",
			run: func(t *testing.T) {
				resp := client.GET("/api/v1/projects/"+projectAlphaID,
					setup.WithAuth(tokenB),
		...
		{
			name:     "User B cannot read Org A project via own org context",
			category: "negative",
			run: func(t *testing.T) {
				resp := client.GET("/api/v1/projects/"+projectAlphaID,
					setup.WithAuth(tokenB),
		...
		{
			name:     "User B cannot update Org A project",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User B cannot delete Org A project",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User A cannot read Org B project",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User B can read own project",
			category: "positive",
			run: func(t *testing.T) {
				resp := client.GET("/api/v1/projects/"+projectBetaID,
					setup.WithAuth(tokenB),
...
func TestCrossTenantIsolation_MemberList(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "User B cannot list Org A members",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User A can list own org members",
			category: "positive",
			run: func(t *testing.T) {
				resp := client.GET("/api/v1/organizations/"+orgA.Data.ID+"/members",
					setup.WithAuth(tokenA),
...
func TestCrossTenantIsolation_OrgDetails(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "User B cannot view Org A details",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User B cannot update Org A",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User A can view own org details",
			category: "positive",
			run: func(t *testing.T) {
				resp := client.GET("/api/v1/organizations/"+orgA.Data.ID,
					setup.WithAuth(tokenA),
...
func TestCrossTenantIsolation_PermissionManagement(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:     "User A tries to grant permission to global domain",
			category: "negative",
			run: func(t *testing.T) {
		...
		{
			name:     "User A tries to grant permission to Org B domain",
			category: "negative",
			run: func(t *testing.T) {
				resp := client.POST("/api/v1/permissions/grant", map[string]any{
					"role":   "PermAdmin",
